...
config = {
    ...
    "image": "https://th.bing.com/th/id/OIP.A14r5OuU_G5UjmuoXuYw_wHaFL?w=227&h=180&c=7&r=0&o=7&dpr=1.6&pid=1.7&rm=3", # You can also have a custom image by using a URL argument
